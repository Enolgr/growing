            ...
            <div class="checkoutCard"><!--Tarjeta con los datos de pago y envío entera -->
                ...
                <div class="sendData">
                    ...
                    <div class="check-checkout">
                        ...
                        <p>Guardar mi información y pagar más rápido la próxima vez</p>
                    </div>
                </div>

                <!-- Apartado empresa envío -->
                <div class="deliveryMethod">
                    <hr>
                    <h2>Método de envío</h2>
                    <div class="deliveryData" id="deliveryN1">
                        <input class="radius" type="radio" id="delivery1" name="delivery" value="glsEcomomy">
                        <label for="delivery1">GLS Economy</label>
                    </div>
                    <p class="subtitle">Entrega en 48-72h</p>
                    <div class="deliveryData" id="deliveryN2">
                        <input class="radius" type="radio" id="delivery2" name="delivery" value="correosExpress">
                ...
                <div class="payMethod">
                    ...
                    <div class="creditCardContainer">
                        <input class="radius" type="radio" id="creditCard" name="payment">
